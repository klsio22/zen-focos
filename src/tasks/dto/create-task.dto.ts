...
export class CreateTaskDto {
  @ApiProperty({ description: 'Task title', maxLength: 255, example: 'Complete project documentation' })
  @IsString()
  @MaxLength(255)
  title: string;
  ...
  @ApiPropertyOptional({ description: 'Completed pomodoros', minimum: 0, example: 0 })
  @IsInt()
  @Min(0)
  @IsOptional()
